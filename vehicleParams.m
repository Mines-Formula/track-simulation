...
params.mass  = 14.2972;   % slug
params.mu    = 1.8;   % grip 
params.a_max = 36.1;     % ft/s^2
params.b_max = 52.5;    % ft/s^2
params.g     = 32.2;  % gravity, ft/s^2
params.wheel_rad = 8; % radius of the wheel (hoosier 43070, 16" diameter - nominal)
